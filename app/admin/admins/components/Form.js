        ...
        <div className='flex flex-col gap-3 bg-[#fbe1e3] rounded-xl p-6 w-full md:w-[400px]'>
            ...
            <form className='flex flex-col gap-3'
                ...
                <div className='flex flex-col gap-1'>
                    <label htmlFor='admin-name' className='text-gray-500 text-sm'>Name <span className='text-red-500'>*</span></label>
                    <input
                        id='admin-name'
                        name='admin-name'
                        type="text"
                ...
                <div className='flex flex-col gap-1'>
                    <label htmlFor='admin-email' className='text-gray-500 text-sm'>Email <span className='text-red-500'>*</span></label>
                    <input
                        id='admin-email'
                        name='admin-email'
                        type="email"
                ...
                <div className='flex flex-col gap-1'>
                    <label htmlFor='admin-name' className='text-gray-500 text-sm'>Image <span className='text-red-500'>*</span></label>
                    {image && (
